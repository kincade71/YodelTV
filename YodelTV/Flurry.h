 ...
 *  logEvent({String} eventName, {object} params)
 *  logTimedEvent({String} eventName)
 *  logTimedEvent({String} eventName, {object} params)
 *  endTimedEvent({String} eventName, {object} params)
 *  logError({String} eventName, {String} message, {object} error)
 *  -> error : {
 *              errorDomain: {String},
                errorID: {Number},
                userInfo: {object}
